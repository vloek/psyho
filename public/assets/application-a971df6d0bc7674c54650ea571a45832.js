...
(function() {
  jQuery(function() {
    return setInterval(function() {
      var delay, first, second;
      first = $('.switchable_title.short');
      second = $('.switchable_title.long');
      delay = 500;
      if (first.css('display') === 'block') {
        return first.fadeOut(delay, function() {
          return second.fadeIn(delay);
        });
      } else {
        return second.fadeOut(delay, function() {
          return first.fadeIn(delay);
        });
      }
    }, 10000);
  });
...
$( document ).ready(function() {
    ...
    //     jQuery('.js-switchable-text').each(function(){
    //         var _this = jQuery(this);
    //         if (_this.is(':visible')){
    //             _this.fadeOut(400);
    //             setTimeout(function(){
    //                 if (_this.next().hasClass('js-switchable-text'))
    //                     _this.next().fadeIn(800);
    //                 else
    //                     jQuery('.js-switchable-text').eq(0).fadeIn(800);
    //             }, 400);
    //             return false;
    //         }
    //     });
    ...
    //         var $popup = jQuery('.pseudo-link-target#' + target);
    //         if($popup.size() > 0) {
    //             $popup.show();
    ...
    // });
    // 
    // $('.pseudo-link-target .popups-close').click(function(e){
    //     var $target = jQuery(this).parents('.pseudo-link-target');
